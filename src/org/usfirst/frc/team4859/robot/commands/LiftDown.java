...
public class LiftDown extends Command {
	public LiftDown() // Takes control of the Lifter subsystem so no other command runs on it
	{
	...
	protected void execute() // Runs the LiftDown method in the Lifter subsystem every 20ms/50 times per second
	{
		Robot.lifter.liftDown();
	}
